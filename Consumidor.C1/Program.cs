...
Console.Title = "Consumidor.C1";
Console.OutputEncoding = System.Text.Encoding.UTF8;
const string consumerName = "Consumidor.C1";
const string queueName = "fila_promocoes_c1";
const string exchangeName = "Promoções";
string[] routingKeys = ["promocao.categoria.A", "promocao.categoria.B"];
